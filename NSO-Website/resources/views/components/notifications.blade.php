...
<!-- Dropdown menu -->
<div id="dropdownNotification" class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-white dark:divide-black" aria-labelledby="dropdownNotificationButton">
  ...
  <div class="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <a href="{{$notification->data['link']}}" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
        <div class="flex-shrink-0">
        </div>
        <div class="w-full ps-3">
          <div>{{$notification->data['message']}}</div>
            <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400">Click here to view</div>
        </div>
      </a>
      @endforeach
  </div>
